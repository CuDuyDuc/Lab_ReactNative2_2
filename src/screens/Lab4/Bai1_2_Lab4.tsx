    ...
    return (
        <ContainerComponent>
            <SectionComponent>
                ...
                <Image style={{ width: 200, height: 200 ,borderRadius:100, margin: 30}} source={{ uri: selectImage || 'https://st.quantrimang.com/photos/image/2020/02/22/avatar-den-co-don-9.png' }} />
                </RowComponent>
            </SectionComponent>
            <SectionComponent>
